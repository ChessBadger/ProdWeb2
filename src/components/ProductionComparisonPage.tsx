...
type GraphTab = "overall" | "breakdown" | "trend";
type TableSortKey = "label" | "delta" | "percentDiff" | `entity:${string}`;
type Timeframe =
  | "all"
  | "last7"
  | "last30"
...
const getDiffStats = (values: number[]) => {
  if (!values.length) {
